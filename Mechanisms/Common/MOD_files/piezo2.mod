...
PARAMETER {	
    ...
    force_sensitivity = 0.08    : Force sensitivity parameter (reduced from 1.0)
    force_threshold = 0.3       : Minimum force threshold (pN)
    g_single = 30e-12           : Single channel conductance (27 pS)
