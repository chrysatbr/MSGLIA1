...
#define nrn_init _nrn_init__KCa31
#define _nrn_initial _nrn_initial__KCa31
#define nrn_cur _nrn_cur__KCa31
#define _nrn_current _nrn_current__KCa31
#define nrn_jacob _nrn_jacob__KCa31
#define nrn_state _nrn_state__KCa31
#define _net_receive _net_receive__KCa31 
#define rates rates__KCa31 
#define states states__KCa31 
...
#define EC50_ca _p[1]
#define EC50_ca_columnindex 1
#define ik _p[2]
#define ik_columnindex 2
#define gk _p[3]
#define gk_columnindex 3
#define oinf _p[4]
#define oinf_columnindex 4
#define otau _p[5]
#define otau_columnindex 5
#define o _p[6]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_KCa31", _hoc_setdata,
 "rates_KCa31", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define nHill nHill_KCa31
 double nHill = 3.5;
#define tau_max tau_max_KCa31
 double tau_max = 50;
#define tau_min tau_min_KCa31
 double tau_min = 5;
 ...
 "nHill_KCa31", &nHill_KCa31,
 "tau_min_KCa31", &tau_min_KCa31,
 "tau_max_KCa31", &tau_max_KCa31,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 KCa31 KCa31.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "KCa3.1 (IK) Calcium-Activated Potassium Channel for Microglia";
...
static int  rates ( _threadargsprotocomma_ double _lcai ) {
   if ( _lcai < 1e-9 ) {
     ...
     oinf = pow( _lcai , nHill ) / ( pow( _lcai , nHill ) + pow( EC50_ca , nHill ) ) ;
     }
   otau = tau_min + ( tau_max - tau_min ) * ( 1.0 - oinf ) ;
    return 0; }
