...
#define use_inactivation _p[1]
#define use_inactivation_columnindex 1
#define ik _p[2]
...
#define k_n k_n_Kv13
 double k_n = 7;
#define tau_h_max tau_h_max_Kv13
 double tau_h_max = 2000;
#define tau_h_min tau_h_min_Kv13
 double tau_h_min = 500;
#define tau_n_max tau_n_max_Kv13
 double tau_n_max = 15;
#define tau_n_min tau_n_min_Kv13
 double tau_n_min = 2;
#define vhalf_h vhalf_h_Kv13
 double vhalf_h = -50;
#define vhalf_n vhalf_n_Kv13
 double vhalf_n = -27;
 ...
 "vhalf_n_Kv13", &vhalf_n_Kv13,
 "k_n_Kv13", &k_n_Kv13,
 "vhalf_h_Kv13", &vhalf_h_Kv13,
 "k_h_Kv13", &k_h_Kv13,
 "tau_n_min_Kv13", &tau_n_min_Kv13,
 "tau_n_max_Kv13", &tau_n_max_Kv13,
 "tau_h_min_Kv13", &tau_h_min_Kv13,
 "tau_h_max_Kv13", &tau_h_max_Kv13,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Kv13 Kv13.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Kv1.3 Potassium Channel for Microglia (Improved)";
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
 ...
 ninf = 1.0 / ( 1.0 + exp ( - ( _lv - vhalf_n ) / k_n ) ) ;
   ntau = tau_n_min + ( tau_n_max - tau_n_min ) * exp ( - ( pow( ( _lv + 40.0 ) , 2.0 ) ) / 500.0 ) ;
   hinf = 1.0 / ( 1.0 + exp ( - ( _lv - vhalf_h ) / k_h ) ) ;
   htau = tau_h_min + ( tau_h_max - tau_h_min ) / ( 1.0 + exp ( ( _lv + 30.0 ) / 20.0 ) ) ;
    return 0; }
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   if ( use_inactivation  == 1.0 ) {
     gk = gkbar * pow( n , 4.0 ) * h ;
     }
   else {
     gk = gkbar * pow( n , 4.0 ) ;
     }
...
#if NMODL_TEXT
static const char* nmodl_filename = "Kv13.mod";
static const char* nmodl_file_text = 
