...
#define rectification _p[3]
#define rectification_columnindex 3
#define ek _p[4]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "k_ion");
 	...
 	ivoc_help("help ?1 Kir21 Kir21.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Kir2.1 Inward Rectifier Potassium Channel for Microglia";
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   rectification = 1.0 / ( 1.0 + exp ( ( v - ek - vhalf ) / k ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "Kir21.mod";
static const char* nmodl_file_text = 
